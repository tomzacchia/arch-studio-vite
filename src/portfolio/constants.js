import seraphMobile from "../assets/portfolio/tablet/image-seraph.jpg";
import seraphTablet from "../assets/portfolio/mobile/image-seraph.jpg";
...
import desolMobile from "../assets/portfolio/mobile/image-del-sol.jpg";
import desolTablet from "../assets/portfolio/tablet/image-del-sol.jpg";
import desolDesktop from "../assets/portfolio/desktop/image-del-sol.jpg";
...
import b228Mobile from "../assets/portfolio/mobile/image-228b.jpg";
import b228Tablet from "../assets/portfolio/tablet/image-228b.jpg";
import b228Desktop from "../assets/portfolio/desktop/image-228b.jpg";
...
const cardsConfig = [
  {
    ...
    bgImageUrlTablet: seraphMobile,
    bgImageUrlMobile: seraphTablet,
    bgImageUrlDesktop: seraphDesktop,
  },
  {
    name: "Eebox Building",
    subtitle: "August 2017",
    bgImageUrlMobile: eeboxMobile,
    bgImageUrlTablet: eeboxTablet,
    bgImageUrlDesktop: eeboxDesktop,
  },
  {
    name: "Federal II Tower",
    subtitle: "March 2017",
    bgImageUrlMobile: federalMobile,
    bgImageUrlTablet: federalTablet,
    bgImageUrlDesktop: federalDesktop,
  },
  {
    name: "Project Del Sol",
    subtitle: "January 2016",
    bgImageUrlMobile: desolMobile,
    bgImageUrlTablet: desolTablet,
    bgImageUrlDesktop: desolDesktop,
  },
  {
    name: "Le Prototype",
    subtitle: "October 2015",
    bgImageUrlMobile: prototypeMobile,
    bgImageUrlTablet: prototypeTablet,
    bgImageUrlDesktop: prototypeDesktop,
  },
  {
    name: "228B Tower",
    subtitle: "April 2015",
    bgImageUrlMobile: b228Mobile,
    bgImageUrlTablet: b228Tablet,
    bgImageUrlDesktop: b228Desktop,
  },
  {
    name: "Grand Edelweiss Hotel",
    subtitle: "September 2019",
    bgImageUrlMobile: edelweissMobile,
    bgImageUrlTablet: edelweissTablet,
    bgImageUrlDesktop: edelweissDesktop,
  },
  {
    name: "Netcry Tower",
    subtitle: "August 2012",
    bgImageUrlMobile: netcryMobile,
    bgImageUrlTablet: netcryTablet,
    bgImageUrlDesktop: netcryDesktop,
  },
  {
    name: "Hypers",
    subtitle: "January 2012",
    bgImageUrlMobile: hypersMobile,
    bgImageUrlTablet: hypersTablet,
    bgImageUrlDesktop: hypersDesktop,
  },
  {
    name: "SXIV Tower",
    subtitle: "March 2011",
    bgImageUrlMobile: sxivMobile,
    bgImageUrlTablet: sxivTablet,
    bgImageUrlDesktop: sxivDesktop,
  },
  {
    name: "Trinity Bank Tower",
    subtitle: "September 2010",
    bgImageUrlMobile: trinityMobile,
    bgImageUrlTablet: trinityTablet,
    bgImageUrlDesktop: trinityDesktop,
  },
  {
    name: "Project Paramour",
    subtitle: "February 2008",
    bgImageUrlMobile: paramourMobile,
    bgImageUrlTablet: paramourTablet,
    bgImageUrlDesktop: paramourDesktop,
  },
];
